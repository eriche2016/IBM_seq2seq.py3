...
class Seq2seq(nn.Module):
    ...
    def forward(self, input_variable, target_variable=None,
        ...
        if target_variable is None:
            input_variable = sorted(input_variable, key=len, reverse=True)
        else:
        ...
        # if teacher_forcing_ratio = 0(by default), then we use the model by feeding predicted 
        # symbol to the rnn  
        # if target_varible is None, then we use the model by feeding predicted symbol 

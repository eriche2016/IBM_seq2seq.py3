...
class SupervisedTrainer(object):
    ...
    def _train_batch(self, input_variable, target_variable, model, teacher_forcing_ratio):
        loss = self.loss
        # Forward propagation
        # by default, enven if teacher_forcing_ratio = 0, if we pass target_variable, then 
        # we training it with full teacher forcing ratio = 1 
